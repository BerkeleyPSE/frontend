...
const genRow = (label, value) => checkEmpty(value) &&
          ...
          data && data.key ?
            <div className="row mb-4">
              <div className="col-12 col-md-5 text-center text-md-left mb-4 mb-md-0">
                <img src={`https://res.cloudinary.com/berkeleypse-tech/image/upload/f_auto,fl_force_strip.progressive,q_auto:best/brothers/${data.key}.png`}/>
              </div>
